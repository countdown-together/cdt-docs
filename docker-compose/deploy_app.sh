...
BASE_COMPOSE_FILE=$CDT_DOCS/docker-compose/docker-compose.yml
PROD_COMPOSE_FILE=$CDT_DOCS/docker-compose/docker-compose.prod.yml

echo "Using compose file: '$BASE_COMPOSE_FILE'"
